        ...
        <div style={{
            ...
            <div style={{
                ...
                <VictoryPie
                    ...
                    data={[{y: 1 - (balance === 0 ? 1 : balance), label: ' '}, {y: balance, label: ' '}].reverse()}
                />
                <div style={{
            ...
            <div onClick={onClick} style={{
                ...
                {balance > 0 && balance !== 1 && (
                    <>
                        <svg style={{marginRight: 17}} width="9" height="10" viewBox="0 0 9 10" fill="none"
                ...
                {balance === 1 && (
                    <>
                        <svg style={{marginRight: 7}} width="12" height="12" viewBox="0 0 12 12" fill="none"
                             xmlns="http://www.w3.org/2000/svg">
                            <path
